...
#define DEF_BOOST_GPU				(320)
#define DEF_BOOST_HOLD_CYCLES			(20)
...
static unsigned int stored_sampling_rate = 47500;
...
static struct dbs_tuners {
	...
	.up_threshold_hotplug_2 = 69,
	.up_threshold_hotplug_3 = 79,
	.down_threshold = 50,
